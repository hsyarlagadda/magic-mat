...
def launch():
    try:
        ...
        # Simulate keyboard shortcut to search "Wi-Fi"
        subprocess.call(["osascript", "-e", 'tell application "System Events" to keystroke "Wi-Fi"'])

        print("Navigating to Wi-Fi settings...")
    except Exception as e:
        print(f"Failed to open Wi-Fi settings: {e}")
